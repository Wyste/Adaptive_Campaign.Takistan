...
Wyste          | 05/03/2015    | Handles the pickup of Intellegence and what happens.
______________________________________________________________________________________________________________________*/
// RETURN: NOTHING
// USAGE : [_intelItem] call AIO_fnc_intelpickup

if (AIO_DEBUG) then {
  ["SCRIPT STARTING| fn_intelpickup.sqf"] call ALiVE_fnc_Dump;
  ["fn_intelpickup.sqf",_this] call DEBUG_fnc_dumpParams;
};
